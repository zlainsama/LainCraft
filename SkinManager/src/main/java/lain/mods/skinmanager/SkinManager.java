...
@Mod(modid = "SkinManager", name = "SkinManager", version = "", dependencies = "required-after:LainCraftCore", useMetadata = true)
public class SkinManager implements IPacketHandler, IConnectionHandler
{
    ...
    {
        config = new Config(new File(SharedConstants.getLainCraftDirFile(), "SkinManager.cfg"), "SkinManager");
